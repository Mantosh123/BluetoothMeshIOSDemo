 ...
 */
typedef void(^SBMNodeControlBindAppKeySuccess)(void);
 ...
 */
typedef void(^SBMNodeControlBindAppKeyError)(NSError* error);

/**
 Callback for successfull unbinding operation.
 */
typedef void(^SBMNodeControlUnbindAppKeySuccess)(void);
...
/**
 ...
 @param error Error describing reason of failure.
 */
typedef void(^SBMNodeControlUnbindAppKeyError)(NSError* error);
...
/**
 Binds node to specified application key.

 @param appKey Application key to bind node to.
 @param successCallback Action invoked when operation succeeds.
 @param errorCallback Action invoked when operation fails.
 */
- (void)bindTo:(SBMApplicationKey*)appKey successCallback:(SBMNodeControlBindAppKeySuccess)successCallback errorCallback:(SBMNodeControlBindAppKeyError)errorCallback;

/**
 Unbinds node from specified application key.

 @param appKey Application key to unbind node from.
 @param successCallback Action invoked when operation succeeds.
 @param errorCallback Action invoked when operation fails.
 */
- (void)unbindFrom:(SBMApplicationKey*)appKey successCallback:(SBMNodeControlUnbindAppKeySuccess)successCallback errorCallback:(SBMNodeControlUnbindAppKeyError)errorCallback;
