//
//  SBMGenericPropertyManufacturer.h
//  BluetoothMesh
//
...
/**
 Generic PropertyManufacturer functionality object. It defines a state representing a device property of an element that is programmed by a manufacturer and can be read.
 */
@interface SBMGenericPropertyManufacturer : SBMGenericProperty<SBMControlValueGetWithParamsSigModel, SBMControlValueSetSigModel>
...
/**
 ...
 @return An initialized generic property object, or nil if an object could not be created.
 */
- (instancetype)initWithId:(UInt16)identifier access:(UInt8)access;
