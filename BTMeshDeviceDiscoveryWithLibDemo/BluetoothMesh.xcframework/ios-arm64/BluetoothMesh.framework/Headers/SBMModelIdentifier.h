...
typedef NS_ENUM(NSInteger, SBMModelIdentifier) {
    ...
    SBMModelIdentifierRemoteProvisioningServer = 0x0004, /**<Mesh Model Remote Provisioning Server */
    SBMModelIdentifierRemoteProvisioningClient = 0x0005, /**<Mesh Model Remote Provisioning Client */
    ...
    SBMModelIdentifierTimeClient = 0x1202, /**< Mesh Model Time Client */
    ...
    SBMModelIdentifierBLOBServer = 0x1400, /**< Mesh Model BLOB Server */
    SBMModelIdentifierBLOBClient = 0x1401, /**< Mesh Model BLOB Client */
    SBMModelIdentifierFirmwareUpdateServer = 0x1402, /**< Mesh Model Firmware Update Server */
    SBMModelIdentifierFirmwareUpdateClient = 0x1403, /**< Mesh Model Firmware Update Client */
    SBMModelIdentifierFirmwareDistributionServer = 0x1404, /**< Mesh Model Firmware Distribution Server */
    SBMModelIdentifierFirmwareDistributionClient = 0x1405, /**< Mesh Model Firmware Distribution Client */
    
    SBMModelIdentifierClientNotKnown = NSNotFound /**< Mesh Model Unknown */
};
